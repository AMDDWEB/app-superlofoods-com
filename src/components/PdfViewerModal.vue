<template>
  <ion-modal :breakpoints="[1]" :is-open="isOpen" @didDismiss="closeModal" :swipe-to-close="false"
    ...
    <ion-content>
      <div>
        <div class="pdf-controls">
          <ion-button shape="round" fill="outline" size="small" :disabled="currentPage === 1"
          ...
          <ion-button shape="round" fill="outline" size="small" :disabled="currentPage === totalPages"
...
.pdf-container {
  ...
  touch-action: auto;
  /* Restored default touch behavior for scrolling */
  position: relative;
}
